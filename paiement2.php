  ...
  <head>
    ...
    <nav>
      <h1>Catégories :</h1>
		...
		<H2>Cheque :</h2>
		<a href="cheque.php"><img class="moyen" src="images/cheque.jpg" alt=\"logo cheque"></a></br></br></br></br>
		<hr size="3"></br>
		<H2>Paypal :</h2>
		<?php
        echo "<a href=\"paypal.php\" onclick=window.open(\"https://www.paypal.com/fr/home.html\", \"width=500,height=500\")><img class=\"moyen\" src=\"images/paypal.jpg\" alt=\"logo paypal\"></a></br>";
        ?>
		</br></br><hr size="3">
		</section>
