  ...
  <head>
    ...
    <nav>
      <h1>Catégories :</h1>
		...
		<H2>Paypal :</h2>
		<img class="moyen" src="images/paypal.jpg" alt=\"logo paypal"></br>
		</br></br><hr size="3"></br>
		Une page s'est ouverte sur laquelle vous pouvez payer.</br>
		Après le paiement, un administrateur pourra valider votre commande.</br>
		</section>
